				...
				players: []PlayerInfo{
					{
						EvrID:    evr.EvrId{PlatformCode: 4, AccountId: 123456789},
						Team:     0,
						Rating:   types.Rating{Mu: 12, Sigma: 8.333},
						JoinTime: 0.0,
					},
					{
						EvrID:    evr.EvrId{PlatformCode: 4, AccountId: 987654321},
