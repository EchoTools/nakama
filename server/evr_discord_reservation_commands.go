...
func (h *ReservationSlashCommandHandler) handleCheckReservation(ctx context.Context, dg *discordgo.Session, i *discordgo.InteractionCreate, _, _ string, options []*discordgo.ApplicationCommandInteractionDataOption) error {
	if len(options) == 0 {
...
func (h *ReservationSlashCommandHandler) handleListReservations(ctx context.Context, dg *discordgo.Session, i *discordgo.InteractionCreate, _, guildID string, options []*discordgo.ApplicationCommandInteractionDataOption) error {
...
func (h *ReservationSlashCommandHandler) handleRemoveReservation(_ context.Context, dg *discordgo.Session, i *discordgo.InteractionCreate, _, _ string, _ []*discordgo.ApplicationCommandInteractionDataOption) error {
	// TODO: Implement reservation removal
	return h.respondError(dg, i, "Remove reservation not yet implemented")
}

func (h *ReservationSlashCommandHandler) handleReservationStatus(_ context.Context, dg *discordgo.Session, i *discordgo.InteractionCreate, _, _ string, _ []*discordgo.ApplicationCommandInteractionDataOption) error {
