...
func createTestMatchRegistryWithInterval(_ fatalable, logger *zap.Logger, intervalMs int) (*LocalMatchRegistry, RuntimeMatchCreateFunction, context.CancelFunc, error) {
