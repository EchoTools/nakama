	...
	return []settingsPreset{
		{
			...
			Settings: ServiceSettingsData{
				Matchmaking: GlobalMatchmakingSettings{
					EnableTicketReservation:        false,
					WaitTimePriorityThresholdSecs:  120,
					PartySkillBoostPercent:         0.10,
					UseSnakeDraftTeamFormation:     true,
				},
			},
		},
		{
			Name: "reservation_default",
			Settings: ServiceSettingsData{
				Matchmaking: GlobalMatchmakingSettings{
		...
		{
			Name: "reservation_aggressive",
			Settings: ServiceSettingsData{
				Matchmaking: GlobalMatchmakingSettings{
					EnableTicketReservation:        true,
					ReservationThresholdSecs:       30,
					MaxReservationRatio:            0.6,
					ReservationSafetyValveSecs:     180,
					WaitTimePriorityThresholdSecs:  60,
					PartySkillBoostPercent:         0.10,
					UseSnakeDraftTeamFormation:     true,
		...
		},
		{
			...
			Settings: ServiceSettingsData{
				Matchmaking: GlobalMatchmakingSettings{
					...
					WaitTimePriorityThresholdSecs:  120,
					PartySkillBoostPercent:         0.10,
					UseSnakeDraftTeamFormation:     false,
				},
			},
		},
		{
			Name: "high_party_boost",
			Settings: ServiceSettingsData{
				Matchmaking: GlobalMatchmakingSettings{
					EnableTicketReservation:        true,
					ReservationThresholdSecs:       90,
