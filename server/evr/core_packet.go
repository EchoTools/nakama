...
var (
	...
	SymbolTypes = map[uint64]interface{}{
		...
		0x7777777777770300: (*GameServerPlayerSessionsLocked)(nil),
		0x7777777777770400: (*ERGameServerPlayerSessionsUnlocked)(nil),
		...
		0x7777777777770900: (*GameServerChallengeRequest)(nil),
