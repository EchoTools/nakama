...
func NewEulaDocument(version, versionGa int, linkURL string) *EulaDocument {
	...
	return &EulaDocument{
		...
		Text:                          "This network, weaving through basements, is a work of fiction. Uptime guarantees are comically optimistic; reliance on this service is advised against for anyone.",
		TextGameAdmin:                 "This network, weaving through basements, is a work of fiction. Uptime guarantees are comically optimistic; reliance on this service is advised against for anyone.",
