...
type Chunk struct {
	...
	Data  struct {
		...
		UpdateProfile                      *UpdateProfile                      `struct-case:"0x6d54a19a3ff24415" json:",omitempty"`
		BroadcasterStartSession            *BroadcasterStartSession            `struct-case:"0x7777777777770000" json:",omitempty"`
		GameServerSessionStarted           *GameServerSessionStarted           `struct-case:"0x7777777777770100" json:",omitempty"`
		BroadcasterSessionEnded            *BroadcasterSessionEnded            `struct-case:"0x7777777777770200" json:",omitempty"`
		GameServerPlayerSessionsLocked     *GameServerPlayerSessionsLocked     `struct-case:"0x7777777777770300" json:",omitempty"`
		ERGameServerPlayerSessionsUnlocked *ERGameServerPlayerSessionsUnlocked `struct-case:"0x7777777777770400" json:",omitempty"`
		...
		GameServerChallengeRequest         *GameServerChallengeRequest         `struct-case:"0x7777777777770900" json:",omitempty"`
