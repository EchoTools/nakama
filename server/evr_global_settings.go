...
type GlobalMatchmakingSettings struct {
	...
	EarlyQuitLossThreshold         float64                 `json:"early_quit_loss_threshold"`           // Threshold (0.0-1.0) for EarlyQuits/GamesPlayed ratio above which early quits count as losses in profile stats. 0.0 = disabled.
