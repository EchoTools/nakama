...
const (
	...
	MatchMaxSize                             = 14 // The total max players (not including the broadcaster) for a EVR lobby.
	MatchMaxSocialSize                       = 12 // The total max players (not including the broadcaster) for a EVR social lobby.
