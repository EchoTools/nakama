...
type TeamMetadata struct {
	...
	RankPercentileAverage float64 `json:"rank_percentile,omitempty"`
...
type GameState struct {
	...
	RoundNumber            int                        `json:"round_number"`                      // The current round number
	...
	Teams                  map[RoleIndex]TeamMetadata `json:"teams,omitempty"`                   // Metadata for each team
}
