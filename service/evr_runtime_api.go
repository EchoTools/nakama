...
func NewAppAPIAcceptor(ctx context.Context, logger runtime.Logger, db *sql.DB, nk runtime.NakamaModule, initializer runtime.Initializer, config server.Config) func(http.ResponseWriter, *http.Request) {
