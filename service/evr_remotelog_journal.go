...
func NewUserRemoteLogJournalRegistry(ctx context.Context, logger *zap.Logger, nk runtime.NakamaModule, sessionRegistry server.SessionRegistry) *UserLogJouralRegistry {
