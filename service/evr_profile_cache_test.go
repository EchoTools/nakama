...
func createTestProfileRegistry(t *testing.T, logger *zap.Logger) (*ProfileCache, error) {
	...
	db := NewDB(t)
	metrics := server.NewLocalMetrics(logger, logger, db, cfg)
	nk := server.NewRuntimeGoNakamaModule(logger, db, nil, cfg, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
