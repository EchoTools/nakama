...
func NewProfileRegistry(nk runtime.NakamaModule, db *sql.DB, logger runtime.Logger, metrics server.Metrics, sessionRegistry server.SessionRegistry) *ProfileCache {
